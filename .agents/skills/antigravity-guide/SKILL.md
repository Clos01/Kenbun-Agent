...
-   **Antigravity IDE**: [references/ide.md](references/ide.md)
    -   Covers the standalone AI-first IDE, sidebar chat panels, and inline code
        lenses.
-   **Antigravity 2.0**: [references/app.md](references/app.md) & [references/antigravity_2_0_quickstart.md](references/antigravity_2_0_quickstart.md)
    -   Covers the parallel desktop application, left-hand sidebar, chat canvas,
        HTML Auxiliary Pane, system requirements, modes, shortcuts, and slash commands (`/goal`, `/grill-me`, `/schedule`, `/browser`).
-   **Antigravity Remote Control & Daemon**: [references/remote_control.md](references/remote_control.md)
    -   Covers `agy --remote-control` daemon setup (`agy-daemon.sh`), launchd/systemd services, port probing, multi-account routing, and Protobuf EOF troubleshooting.
