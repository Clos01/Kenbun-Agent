...
- **Pre-Execution Guard**: Before running any terminal command, subprocess, or SSH dispatch that executes newly generated code.
- **Code Review & Refactoring**: When reviewing pull requests, inspecting diffs, or creating new components.
- **Background Watchdog Mode**: When developing continuously to ensure workspace files remain 100% clean.
