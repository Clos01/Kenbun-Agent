...
def test_parse_github_repo():
    assert _parse_github_repo("https://github.com/Clos01/Kenbun-Agent") == ("nousresearch", "kenbun-agent")
    assert _parse_github_repo("git@github.com:Clos01/Kenbun-Agent.git") == ("nousresearch", "kenbun-agent")
    assert _parse_github_repo("Clos01/Kenbun-Agent") == ("nousresearch", "kenbun-agent")
