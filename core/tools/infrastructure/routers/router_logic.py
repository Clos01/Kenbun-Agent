...
from core.tools.infrastructure.orchestrator import log_to_dashboard, save_topology, PIPELINES, check_connectivity, extract_json_array
...
async def run_pipeline(
    ...
    if workflow in ["bug_fix", "code_review"] and (file_path or code_snippet):
        try:
            from core.tools.audit.safe_linter import safe_pre_flight_linter
