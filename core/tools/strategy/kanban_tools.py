...
def resolve_task_id(task_id: str) -> str:
    ...
    env_id = os.environ.get("KENBUN_KANBAN_TASK") or os.environ.get("KENBUN_KANBAN_TASK")
    if env_id:
        return env_id.strip()
    raise ValueError("Task ID must be provided or set via KENBUN_KANBAN_TASK/KENBUN_KANBAN_TASK environment variable.")
