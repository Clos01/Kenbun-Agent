...
2. Incorporate best practices from state-of-the-art agent architectures (e.g., Nous Kenbun reasoning cues, Figure AI Helix step-by-step physical action grounding, explicit XML tags, strict boundary rules).
