...
- **Solution**: SQLite was chosen for initial local deployment to minimize network overhead. All high-scale knowledge remains on the **Remote PC (127.0.0.1)** via ChromaDB to maintain data sovereignty and performance.
