...
snippet = "rsync -av --exclude=.git --exclude=.venv --exclude=node_modules --exclude=__pycache__ --exclude=.next --exclude=postgres_data --exclude=chroma_data --exclude=.gemini /path/to/Kenbun/ /path/to/kenbun-agent/"
