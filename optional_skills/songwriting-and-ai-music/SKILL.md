...
- **Internal Rhyme:** Rhyming within a line, not just at the ends. *"We pruned the lies from bleeding trees / Distilled the storm from entropy"* — "lies" echoing inside, "trees/entropy" creating echoes.
...
- **Prosody** — lyrics and music supporting each other:
  ...
  - Verse melody typically sits lower, chorus goes higher (flip this if it serves the song).
...
2. Mark the rhyme scheme (ABAB, AABB, etc.).
3. Identify which syllables are **STRESSED**.
4. Note where held/sustained notes fall.
...
- Monosyllabic swaps in key spots keep rhythm intact (e.g. Crime &rarr; Code, Snake &rarr; Noose).
...
### Style/Genre Description Field Formula:
...
- Build a **vocal PERSONA**: *"A weathered torch singer with a smoky alto, slight rasp, who starts vulnerable and builds to devastating power"*.
...
- **Phonetic Respelling:**
  - Spell words as they **SOUND**: "through" &rarr; "thru".
  - Proper nouns have the highest failure rate — test early.
  - "Nous" &rarr; "Noose" (forces correct pronunciation).
...
- **Formatting Rules:**
  - Always spell out numbers: "24/7" &rarr; "twenty four seven".
  - Space acronyms: "AI" &rarr; "A I" or "A-I".
