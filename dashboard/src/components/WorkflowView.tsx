...
export default function WorkflowView({
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)] md:h-[calc(100vh-8.5rem)] relative border border-border rounded-md overflow-hidden select-none bg-neutral">
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3 px-3 sm:px-5 py-3 sm:py-3.5 border-b border-border shrink-0 z-30 bg-card">
        ...
        {/* Primary actions */}
        <div className="flex items-center gap-2 w-full lg:w-auto shrink-0 justify-between lg:justify-end overflow-x-auto no-scrollbar pb-1 lg:pb-0">
